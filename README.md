...
* 📕🍎🤖🔁 [AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) ⭐ 75,818 | 🐛 997 | 🌐 Dart | 📅 2026-08-11 - Open source alternative to Notion. Supports macOS, Windows, Linux, iOS, and Android. `AGPL-3.0` `Flutter/Dart`
...
* 📕 [treesheets](https://github.com/aardappel/treesheets) ⭐ 3,100 | 🐛 73 | 🌐 C++ | 📅 2026-08-21 - Free form data organizer using hierarchical spreadsheet. `Zlib` `C++`
...
* 📕🍎🔁 [DailyVox](https://github.com/intrepidkarthi/dailyvox) ⭐ 14 | 🐛 1 | 🌐 HTML | 📅 2026-08-21 - Free AI voice diary for iOS with on-device transcription, mood tracking, Digital Twin, and knowledge graph. 100% offline, optional iCloud sync. `MIT` `Swift/SwiftUI`
...
* 📖 [nb](https://github.com/xwmx/nb) ⭐ 8,369 | 🐛 150 | 🌐 Shell | 📅 2026-08-20 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application. `AGPL-3.0` `Shell`
...
* 📖 [zk](https://github.com/mickael-menu/zk) ⭐ 2,772 | 🐛 25 | 🌐 Go | 📅 2026-08-03 - A command-line tool helping you to maintain a plain text Zettelkasten or personal wiki. `GPL-3.0` `Go`
* 📖 [IWE](https://github.com/iwe-org/iwe) ⭐ 1,562 | 🐛 3 | 🌐 Rust | 📅 2026-08-15 - A markdown-based knowledge management tool with CLI and LSP server. Turns markdown files into a navigable graph with backlinks and link completion. Works with VS Code, Neovim, Zed, and Helix. `Apache-2.0` `Rust`
* 📕 [lifeos-cli](https://github.com/liujuanjuan1984/lifeos-cli) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2026-08-21 - A terminal-native LifeOS for notes, linked tasks, schedules, events, and timelogs. `Apache-2.0` `Python`

<p align="right"><a href="#contents">back to top</a></p>

### TUI

* 📖 [Toney](https://github.com/SourcewareLab/Toney) ⭐ 200 | 🐛 3 | 🌐 Go | 📅 2026-05-27 - A fast, lightweight, terminal-based note-taking app for the modern developer. `MIT` `Go`
...
* 📖 [vim-wiki](https://github.com/vimwiki/vimwiki) ⭐ 9,510 | 🐛 230 | 🌐 Vim Script | 📅 2026-04-30 - A personal wiki for Vim — a number of linked text files with their own syntax highlighting. `MIT` `Vim Script`
...
* 📕🔁 [AFFiNE](https://github.com/toeverything/AFFiNE) ⭐ 71,736 | 🐛 709 | 🌐 TypeScript | 📅 2026-08-21 - Next-gen knowledge base that brings planning, sorting, and creating all together. Privacy first, open-source, customizable and ready to use. `MIT` `Electron/TypeScript`
* 📕🍎🤖🔁 [SiYuan](https://github.com/siyuan-note/siyuan) ⭐ 45,919 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-21 - A privacy-first, self-hosted, fully open source personal knowledge management software. `AGPL-3.0` `Electron/TypeScript+Go`
* 📖🍎🤖🔁 [Logseq](https://github.com/logseq/logseq) ⭐ 44,552 | 🐛 959 | 🌐 Clojure | 📅 2026-08-21 - Local-first, non-linear, outliner notebook for organizing and sharing your personal knowledge base. `AGPL-3.0` `Electron/ClojureScript`
...
* 📖🔁 [Memos](https://github.com/usememos/memos) ⭐ 62,425 | 🐛 43 | 🌐 Go | 📅 2026-08-21 - Lightweight, self-hosted memo hub. Privacy first. `MIT` `Go/React`
* 📖 [Outline](https://github.com/outline/outline) ⭐ 40,279 | 🐛 86 | 🌐 TypeScript | 📅 2026-08-21 - Fast, collaborative team knowledge base. Self-hosted or cloud. `BSL-1.1` `Web/TypeScript`
* 📖 [Docmost](https://github.com/docmost/docmost) ⭐ 21,432 | 🐛 327 | 🌐 TypeScript | 📅 2026-08-21 - Open-source collaborative wiki and documentation software. Notion/Confluence alternative with real-time collaboration. `AGPL-3.0` `Web/TypeScript`
* 📖🍎🤖🔒🔁 [Notesnook](https://github.com/streetwriters/notesnook) ⭐ 14,447 | 🐛 977 | 🌐 TypeScript | 📅 2026-08-21 - Fully open source and end-to-end encrypted note-taking app available on all platforms. `GPL-3.0` `Web/TypeScript`
...
* 📖 [TiddlyWiki](https://github.com/TiddlyWiki/TiddlyWiki5) ⭐ 8,627 | 🐛 1,145 | 🌐 JavaScript | 📅 2026-08-21 - A self-contained JavaScript wiki for the browser, Node.js, AWS Lambda, and more. `BSD-3-Clause` `Web/JavaScript`
* 📖 [HedgeDoc](https://github.com/hedgedoc/hedgedoc) ⭐ 7,376 | 🐛 267 | 🌐 TypeScript | 📅 2026-08-21 - Real-time collaborative markdown notes. Community successor to CodiMD. `AGPL-3.0` `Web/TypeScript`
* 📖 [SilverBullet](https://github.com/silverbulletmd/silverbullet) ⭐ 5,896 | 🐛 328 | 🌐 TypeScript | 📅 2026-08-21 - Free, open-source self-hosted PWA for markdown notes. `MIT` `TypeScript/Go`
* 📖 [Flatnotes](https://github.com/dullage/flatnotes) ⭐ 3,192 | 🐛 124 | 🌐 Vue | 📅 2026-08-02 - Self-hosted, database-less, plain-text markdown note-taking app. `MIT` `Python/Vue`
...
| [Logseq](https://github.com/logseq/logseq) ⭐ 44,552 \| 🐛 959 \| 🌐 Clojure \| 📅 2026-08-21                 | PKM/Outliner | Markdown  | yes         | —        | Win/Mac/Linux/iOS/Android     | yes     | Free     |
| [SiYuan](https://github.com/siyuan-note/siyuan) ⭐ 45,919 \| 🐛 61 \| 🌐 TypeScript \| 📅 2026-08-21          | PKM          | Database  | yes         | —        | Win/Mac/Linux/iOS/Android/Web | yes     | Freemium |
| [AFFiNE](https://github.com/toeverything/AFFiNE) ⭐ 71,736 \| 🐛 709 \| 🌐 TypeScript \| 📅 2026-08-21        | Workspace    | Database  | yes         | —        | Win/Mac/Linux/Web             | yes     | Freemium |
| [AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) ⭐ 75,818 \| 🐛 997 \| 🌐 Dart \| 📅 2026-08-11           | Workspace    | Database  | yes         | —        | Win/Mac/Linux/iOS/Android     | yes     | Free     |
...
| [Notesnook](https://github.com/streetwriters/notesnook) ⭐ 14,447 \| 🐛 977 \| 🌐 TypeScript \| 📅 2026-08-21 | Notes        | Encrypted | yes         | yes      | Win/Mac/Linux/iOS/Android/Web | —       | Freemium |
