...
* 📕🍎🤖🔁 [AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) ⭐ 76,456 | 🐛 1,028 | 🌐 Dart | 📅 2026-09-01 - Open source alternative to Notion. Supports macOS, Windows, Linux, iOS, and Android. `AGPL-3.0` `Flutter/Dart`
...
* 📕🍎🔁 [DailyVox](https://github.com/intrepidkarthi/dailyvox) ⭐ 17 | 🐛 0 | 🌐 HTML | 📅 2026-09-08 - Free AI voice diary for iOS with on-device transcription, mood tracking, Digital Twin, and knowledge graph. 100% offline, optional iCloud sync. `MIT` `Swift/SwiftUI`
...
* 📖 [nb](https://github.com/xwmx/nb) ⭐ 8,400 | 🐛 151 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application. `AGPL-3.0` `Shell`
...
* 📖 [zk](https://github.com/mickael-menu/zk) ⭐ 2,788 | 🐛 27 | 🌐 Go | 📅 2026-08-31 - A command-line tool helping you to maintain a plain text Zettelkasten or personal wiki. `GPL-3.0` `Go`
* 📖 [IWE](https://github.com/iwe-org/iwe) ⭐ 1,631 | 🐛 0 | 🌐 Rust | 📅 2026-09-08 - A markdown-based knowledge management tool with CLI and LSP server. Turns markdown files into a navigable graph with backlinks and link completion. Works with VS Code, Neovim, Zed, and Helix. `Apache-2.0` `Rust`
* 📕 [lifeos-cli](https://github.com/liujuanjuan1984/lifeos-cli) ⭐ 12 | 🐛 3 | 🌐 Python | 📅 2026-09-08 - A terminal-native LifeOS for notes, linked tasks, schedules, events, and timelogs. `Apache-2.0` `Python`
...
* 📕🔁 [AFFiNE](https://github.com/toeverything/AFFiNE) ⭐ 72,348 | 🐛 730 | 🌐 TypeScript | 📅 2026-09-08 - Next-gen knowledge base that brings planning, sorting, and creating all together. Privacy first, open-source, customizable and ready to use. `MIT` `Electron/TypeScript`
* 📕🍎🤖🔁 [SiYuan](https://github.com/siyuan-note/siyuan) ⭐ 46,237 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-08 - A privacy-first, self-hosted, fully open source personal knowledge management software. `AGPL-3.0` `Electron/TypeScript+Go`
* 📖🍎🤖🔁 [Logseq](https://github.com/logseq/logseq) ⭐ 44,833 | 🐛 944 | 🌐 Clojure | 📅 2026-09-08 - Local-first, non-linear, outliner notebook for organizing and sharing your personal knowledge base. `AGPL-3.0` `Electron/ClojureScript`
...
* 📖🤖🔁 [TidGi](https://github.com/tiddly-gittly/TidGi-Desktop) ⭐ 2,002 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-08 - Customizable personal knowledge-base with git as backup manager and blogging platform, based on TiddlyWiki. `MPL-2.0` `Electron/TypeScript`
...
* 📖🔁 [Memos](https://github.com/usememos/memos) ⭐ 62,852 | 🐛 68 | 🌐 Go | 📅 2026-09-08 - Lightweight, self-hosted memo hub. Privacy first. `MIT` `Go/React`
* 📖 [Outline](https://github.com/outline/outline) ⭐ 40,495 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-08 - Fast, collaborative team knowledge base. Self-hosted or cloud. `BSL-1.1` `Web/TypeScript`
* 📖 [Docmost](https://github.com/docmost/docmost) ⭐ 21,610 | 🐛 325 | 🌐 TypeScript | 📅 2026-09-08 - Open-source collaborative wiki and documentation software. Notion/Confluence alternative with real-time collaboration. `AGPL-3.0` `Web/TypeScript`
* 📖🍎🤖🔒🔁 [Notesnook](https://github.com/streetwriters/notesnook) ⭐ 14,553 | 🐛 1,009 | 🌐 TypeScript | 📅 2026-09-08 - Fully open source and end-to-end encrypted note-taking app available on all platforms. `GPL-3.0` `Web/TypeScript`
...
* 📖 [HedgeDoc](https://github.com/hedgedoc/hedgedoc) ⭐ 7,402 | 🐛 276 | 🌐 TypeScript | 📅 2026-09-08 - Real-time collaborative markdown notes. Community successor to CodiMD. `AGPL-3.0` `Web/TypeScript`
* 📖 [SilverBullet](https://github.com/silverbulletmd/silverbullet) ⭐ 6,021 | 🐛 336 | 🌐 TypeScript | 📅 2026-09-08 - Free, open-source self-hosted PWA for markdown notes. `MIT` `TypeScript/Go`
* 📖 [Flatnotes](https://github.com/dullage/flatnotes) ⭐ 3,216 | 🐛 124 | 🌐 Vue | 📅 2026-08-29 - Self-hosted, database-less, plain-text markdown note-taking app. `MIT` `Python/Vue`
...
* 📖 [MDLook](https://mdlook.com) ([GitHub](https://github.com/djosci/MDLook) ⭐ 94 | 🐛 24 | 📅 2026-03-18) - Portable offline Markdown editor for Windows using WebView2, with live preview, dark mode, KaTeX math, and Mermaid diagrams.
...
| [Logseq](https://github.com/logseq/logseq) ⭐ 44,833 \| 🐛 944 \| 🌐 Clojure \| 📅 2026-09-08                   | PKM/Outliner | Markdown  | yes         | —        | Win/Mac/Linux/iOS/Android     | yes     | Free     |
| [SiYuan](https://github.com/siyuan-note/siyuan) ⭐ 46,237 \| 🐛 19 \| 🌐 TypeScript \| 📅 2026-09-08            | PKM          | Database  | yes         | —        | Win/Mac/Linux/iOS/Android/Web | yes     | Freemium |
| [AFFiNE](https://github.com/toeverything/AFFiNE) ⭐ 72,348 \| 🐛 730 \| 🌐 TypeScript \| 📅 2026-09-08          | Workspace    | Database  | yes         | —        | Win/Mac/Linux/Web             | yes     | Freemium |
| [AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) ⭐ 76,456 \| 🐛 1,028 \| 🌐 Dart \| 📅 2026-09-01           | Workspace    | Database  | yes         | —        | Win/Mac/Linux/iOS/Android     | yes     | Free     |
...
| [Notesnook](https://github.com/streetwriters/notesnook) ⭐ 14,553 \| 🐛 1,009 \| 🌐 TypeScript \| 📅 2026-09-08 | Notes        | Encrypted | yes         | yes      | Win/Mac/Linux/iOS/Android/Web | —       | Freemium |
