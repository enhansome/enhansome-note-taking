...
* 📕🍎🤖🔁 [AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) ⭐ 76,903 | 🐛 1,028 | 🌐 Dart | 📅 2026-09-22 - Open source alternative to Notion. Supports macOS, Windows, Linux, iOS, and Android. `AGPL-3.0` `Flutter/Dart`
...
* 📕 [treesheets](https://github.com/aardappel/treesheets) ⭐ 3,123 | 🐛 72 | 🌐 C++ | 📅 2026-09-23 - Free form data organizer using hierarchical spreadsheet. `Zlib` `C++`
...
* 📕🍎🔁 [DailyVox](https://github.com/intrepidkarthi/dailyvox) ⭐ 18 | 🐛 1 | 🌐 HTML | 📅 2026-09-23 - Free AI voice diary for iOS with on-device transcription, mood tracking, Digital Twin, and knowledge graph. 100% offline, optional iCloud sync. `MIT` `Swift/SwiftUI`
...
* 📖 [nb](https://github.com/xwmx/nb) ⭐ 8,409 | 🐛 153 | 🌐 Shell | 📅 2026-08-26 - A command line and local web note-taking, bookmarking, archiving, and knowledge base application. `AGPL-3.0` `Shell`
* 📖 [todo-txt](https://github.com/todotxt/todo.txt-cli) ⭐ 6,176 | 🐛 42 | 🌐 Shell | 📅 2026-09-06 - A simple and extensible shell script for managing your todo.txt file. `GPL-3.0` `Shell`
...
* 📖 [IWE](https://github.com/iwe-org/iwe) ⭐ 1,722 | 🐛 1 | 🌐 Rust | 📅 2026-09-20 - A markdown-based knowledge management tool with CLI and LSP server. Turns markdown files into a navigable graph with backlinks and link completion. Works with VS Code, Neovim, Zed, and Helix. `Apache-2.0` `Rust`
...
* 📕🔁 [AFFiNE](https://github.com/toeverything/AFFiNE) ⭐ 72,909 | 🐛 757 | 🌐 TypeScript | 📅 2026-09-23 - Next-gen knowledge base that brings planning, sorting, and creating all together. Privacy first, open-source, customizable and ready to use. `MIT` `Electron/TypeScript`
* 📕🍎🤖🔁 [SiYuan](https://github.com/siyuan-note/siyuan) ⭐ 46,481 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-24 - A privacy-first, self-hosted, fully open source personal knowledge management software. `AGPL-3.0` `Electron/TypeScript+Go`
* 📖🍎🤖🔁 [Logseq](https://github.com/logseq/logseq) ⭐ 45,036 | 🐛 954 | 🌐 Clojure | 📅 2026-09-23 - Local-first, non-linear, outliner notebook for organizing and sharing your personal knowledge base. `AGPL-3.0` `Electron/ClojureScript`
* 📖🍎🤖🔒🔁 [Standard Notes](https://github.com/standardnotes/app) ⭐ 6,632 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-23 - A free, open-source, and completely encrypted notes app for macOS, Windows, Linux, iOS, and Android. `AGPL-3.0` `Electron/TypeScript`
...
* 📖🔁 [Memos](https://github.com/usememos/memos) ⭐ 63,286 | 🐛 68 | 🌐 Go | 📅 2026-09-23 - Lightweight, self-hosted memo hub. Privacy first. `MIT` `Go/React`
* 📖 [Outline](https://github.com/outline/outline) ⭐ 40,678 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-23 - Fast, collaborative team knowledge base. Self-hosted or cloud. `BSL-1.1` `Web/TypeScript`
* 📖 [Docmost](https://github.com/docmost/docmost) ⭐ 21,771 | 🐛 339 | 🌐 TypeScript | 📅 2026-09-22 - Open-source collaborative wiki and documentation software. Notion/Confluence alternative with real-time collaboration. `AGPL-3.0` `Web/TypeScript`
* 📖🍎🤖🔒🔁 [Notesnook](https://github.com/streetwriters/notesnook) ⭐ 14,626 | 🐛 1,053 | 🌐 TypeScript | 📅 2026-09-23 - Fully open source and end-to-end encrypted note-taking app available on all platforms. `GPL-3.0` `Web/TypeScript`
* 📖⚠️ [CodiMD](https://github.com/hackmdio/codimd) ⭐ 10,150 | 🐛 357 | 🌐 JavaScript | 📅 2025-10-02 - The free software version of HackMD. See [HedgeDoc](https://hedgedoc.org/) for the active community fork. `AGPL-3.0` `Web/JavaScript`
...
* 📖 [HedgeDoc](https://github.com/hedgedoc/hedgedoc) ⭐ 7,443 | 🐛 301 | 🌐 TypeScript | 📅 2026-09-23 - Real-time collaborative markdown notes. Community successor to CodiMD. `AGPL-3.0` `Web/TypeScript`
* 📖 [SilverBullet](https://github.com/silverbulletmd/silverbullet) ⭐ 6,140 | 🐛 352 | 🌐 TypeScript | 📅 2026-09-23 - Free, open-source self-hosted PWA for markdown notes. `MIT` `TypeScript/Go`
...
| [Logseq](https://github.com/logseq/logseq) ⭐ 45,036 \| 🐛 954 \| 🌐 Clojure \| 📅 2026-09-23                   | PKM/Outliner | Markdown  | yes         | —        | Win/Mac/Linux/iOS/Android     | yes     | Free     |
| [SiYuan](https://github.com/siyuan-note/siyuan) ⭐ 46,481 \| 🐛 6 \| 🌐 TypeScript \| 📅 2026-09-24             | PKM          | Database  | yes         | —        | Win/Mac/Linux/iOS/Android/Web | yes     | Freemium |
| [AFFiNE](https://github.com/toeverything/AFFiNE) ⭐ 72,909 \| 🐛 757 \| 🌐 TypeScript \| 📅 2026-09-23          | Workspace    | Database  | yes         | —        | Win/Mac/Linux/Web             | yes     | Freemium |
| [AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) ⭐ 76,903 \| 🐛 1,028 \| 🌐 Dart \| 📅 2026-09-22           | Workspace    | Database  | yes         | —        | Win/Mac/Linux/iOS/Android     | yes     | Free     |
| [Standard Notes](https://github.com/standardnotes/app) ⭐ 6,632 \| 🐛 95 \| 🌐 TypeScript \| 📅 2026-09-23      | Notes        | Encrypted | yes         | yes      | Win/Mac/Linux/iOS/Android/Web | yes     | Freemium |
| [AnyType](https://anytype.io/)                                                                                 | PKM          | Database  | yes         | yes      | Win/Mac/Linux/iOS/Android     | —       | Free     |
| [Notesnook](https://github.com/streetwriters/notesnook) ⭐ 14,626 \| 🐛 1,053 \| 🌐 TypeScript \| 📅 2026-09-23 | Notes        | Encrypted | yes         | yes      | Win/Mac/Linux/iOS/Android/Web | —       | Freemium |
